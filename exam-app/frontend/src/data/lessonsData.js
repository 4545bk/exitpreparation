// AAU IT Exit Exam Study Guide - Detailed Lessons Data for React App
export const LESSONS_DATA = {
  ...
  // Session 1: Programming Fundamentals (indexed as d0_2_x in defaultDays.js, or d0_1_x if two sessions)
  // Let's support both d0_1_x and d0_2_x to be fully compatible with both arrays!
  "d0_1_0": `
  ...
  // Dual mappings for d0_2_x (since react defaultDays has 3 sessions on Day 0)
  "d0_2_0": `
    <p>Primitive types are the basic data blocks built into programming languages.</p>
    <table>
      <thead>
